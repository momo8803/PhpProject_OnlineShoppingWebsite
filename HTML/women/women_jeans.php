...
if(isset($_POST['add_to_cart'])){
    ...
    if(mysqli_num_rows($select_cart) > 0){
        header("Location: women_jeans.php?error=notFound");;
    }else{
        ...
        header("Location: women_jeans.php?success=addedToCart");
    }
...
if(isset($_POST['add_to_wishlist'])){
    ...
    if(mysqli_num_rows($select_wishlist) > 0){
        ...
        header("Location: women_jeans.php?success=addedToWishlist");
    }
...
<?php
      ...
      $select_products = mysqli_query($conn, "SELECT * FROM products WHERE CategoryID = 2001");
      ...
      ?>
              	<div class="Row">
                     <?php }?>	
                       <div class="card">
                             <form method="post" action="women_jeans.php?action=add&id=<?php echo $fetch_product["ProductID"]; ?>">  
                                            <img src="<?php echo $fetch_product["Img"]; ?>">
                                            <img src="<?php echo $fetch_product["Img2"]; ?>" alt="Denim Jeans" class="img-top">
