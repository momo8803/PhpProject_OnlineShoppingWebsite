...
if(isset($_GET['key']))
{
    ...
    $query = "SELECT p.* FROM products p JOIN category c ON p.CategoryID=c.Category_Id WHERE c.Description LIKE '%$getValue%' OR p.ProductName LIKE '%$getValue%' GROUP BY ProductID";
    ...
    if (mysqli_num_rows($run_query)>0) {
        ...
        ?>
            	...
            	<?php }?>
            		<div class="card">
            		 <form method="post" action="result.php?action=add&id=<?php echo $itemst["ProductID"]; ?>">  
