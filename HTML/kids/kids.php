        ...
        <div class="men-category">
            ...
            <section class="men-images">
                <div class="img-container">
                    <img src="../../images/Kids/school-clothes-ft-img.jpg" alt="TOPS"/>
                    <a href="kids_shirts.php"><button class="btn"> TOPS</button></a>
                </div>
                <div class="img-container">
                    <img src="../../images/sale.jpg" alt="Sale"/>
                    <a href="kids_dresses.php"><button class="btn">On Sale</button></a> 
                </div> 
                <div class="img-container">              
                    <img src="../../images/Kids/pexels-photo-7139178.jpg" alt="Pants"/>
                    <a href="kids_dresses.php"><button class="btn">DRESSES</button></a>
                </div>
                <div class="img-container">
                    <img src="../../images/Kids/papayaKIDSclothing.jpg" alt="Shirts"/>
                    <a href="kids_pants.php"><button class="btn">PANTS</button></a>   
                </div> 
            </section>
