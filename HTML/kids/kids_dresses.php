...
if(isset($_POST['add_to_cart'])){
    ...
    if(mysqli_num_rows($select_cart) > 0){
        header("Location: kids_dresses.php?error=notFound");;
    }else{
        ...
        header("Location: kids_dresses.php?success=addedToCart");
    }
...
if(isset($_POST['add_to_wishlist'])){
    ...
    if(mysqli_num_rows($select_wishlist) > 0){
        ...
        header("Location: kids_dresses.php?success=addedToWishlist");
    }
...
<?php
      ...
      $select_products = mysqli_query($conn, "SELECT * FROM products WHERE CategoryID = 2005");
      ...
      ?>
              	<div class="Row">
                     <?php }?>	
                       <div class="card">
                             <form method="post" action="kids_dresses.php?action=add&id=<?php echo $fetch_product["ProductID"]; ?>">  
