...
if(isset($_POST['add_to_cart'])){
    ...
    if(mysqli_num_rows($select_cart) > 0){
        header("Location: men_tshirt.php?error=notFound");;
    }else{
        ...
        header("Location: men_tshirt.php?success=addedToCart");
    }
...
if(isset($_POST['add_to_wishlist'])){
    ...
    if(mysqli_num_rows($select_wishlist) > 0){
        ...
        header("Location: men_tshirt.php?success=addedToWishlist");
    }
...
<?php
      ...
      $select_products = mysqli_query($conn, "SELECT * FROM products WHERE CategoryID = 1001");
      ...
      ?>
              	<div class="Row">
                     <?php }?>	
                       <div class="card">
                             <form method="post" action="men_tshirt.php?action=add&id=<?php echo $fetch_product["ProductID"]; ?>">  
                                            <img src="<?php echo $fetch_product["Img"]; ?>" class="img-top">
                                            <img src="<?php echo $fetch_product["Img2"]; ?>"  >
